        ...
        <Container ref={cardRef}>
            ...
            <ContentContainer show={show}>
                {project.objective && (
                    <>
                        <SecondaryTitle>
                            <Lang name={LangsList.project_objective} />
                        </SecondaryTitle>
                        <p>
                            <Markdown>
                                {LangStringFromILang(project.objective)}
                            </Markdown>
                        </p>
                    </>
                )}
                {project.aimedSkills && (
                    <>
                        <SecondaryTitle>
                            <Lang name={LangsList.project_aimed_skills} />
                        </SecondaryTitle>
                        <List>
                            {project.aimedSkills.map((skill, index) => (
                                <li key={index}>
                                    <Markdown>
                                        {LangStringFromILang(skill)}
                                    </Markdown>
                                </li>
                            ))}
                        </List>
                ...
                {project.features && (
                    <>
                        <SecondaryTitle>
                            <Lang name={LangsList.project_features} />
                        </SecondaryTitle>
                        <List>
                    ...
                    project.numberOfContributors > 0 && (
                        <ContributorsContainer
                            title={
                                project.numberOfContributors +
                                LangString(
                                    LangsList.project_number_of_contributors
                                )
                            }
                        >
                            {Array.from(
                                Array(project.numberOfContributors),
                                (e, i) => {
                                    return (
                                        <FontAwesomeIcon
                                            icon={faUser}
