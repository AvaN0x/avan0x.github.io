    ...
    return (
        <MenuContainer isOpen={isOpen}>
            {children && (
                <MenuSection>
                    <h1>
                        <Lang name={LangsList.on_this_page} />
                    </h1>
                    {children}
                </MenuSection>
            )}
            ...
            <MenuSection>
                <h1>
                    <Lang name={'website_languages'} />
                </h1>
                <SetLanguage language="fr">
                    <FontAwesomeIcon icon={faGlobe} />
                    <Lang name={LangsList.french} />
                </SetLanguage>
                <SetLanguage language="en">
                    <FontAwesomeIcon icon={faGlobe} />
                    <Lang name={LangsList.english} />
                </SetLanguage>
            </MenuSection>
        </MenuContainer>
    );
...
const SetLanguage = ({
    ...
    const current = (localStorage.getItem('language') || 'fr') === language;
    ...
    return (
        <SetLanguageLink current={current} onClick={handleOnClick}>
            {children}
        </SetLanguageLink>
    );
};
